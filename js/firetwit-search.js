function FireTwitSearch(ref, stem, resultsHandler) {
  this._ref = ref;
  this._term = stem;
...
FireTwitSearch.prototype.containsTerm = function(term) {
  if (term.length < 3) {
    return false;
  } else {
...
FireTwitSearch.prototype.updateTerm = function(term) {
  this._term = term;
  this._raiseFilteredResults();
};

FireTwitSearch.prototype.stopSearch = function() {
