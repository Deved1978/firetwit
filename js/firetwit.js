...
/**
 * The FireTwit object is the primary conduit to the data feed. It provides
 ...
 * to follow. This object knows nothing about the UI, see FireTwit-ui.js for
 ...
 * @return   {FireTwit}
 */
function FireTwit(baseURL, newContext) {
  var self = this;
  this._name = null;
 ...
 */
FireTwit.prototype.onLoginStateChange = function(onLoginStateChange) {
  var self = this;
 ...
 */
FireTwit.prototype.login = function(provider) {
 ...
 */
FireTwit.prototype.logout = function() {
  if (this._uid) {
...
FireTwit.prototype.onLogin = function(user) {
  var self = this;
  if (!user) { return; }
 ...
 */
FireTwit.prototype.onLogout = function() {
  this._user = null;
  this._facebookId = null;
  this._mainUser = null;
  this._fullName = null;
 ...
 */
FireTwit.prototype.getUserInfo = function(user, onComplete,
...
FireTwit.prototype.startSearch = function(resultsHandler) {
  this._searchHandler = resultsHandler;
};

FireTwit.prototype.updateSearchTerm = function(term) {
  ...
  if (isValidStem(term) && term.length >= 3) {
    if (this._currentSearch) {
      ...
      this._currentSearch = new FireTwitSearch(this._firebase, term, this._searchHandler);
    }
  } else {
    this.stopSearching();
  }
...
FireTwit.prototype.stopSearching = function() {
  if (this._currentSearch) {
 ...
 */
FireTwit.prototype.getSpark = function(id, onComplete) {
  var self = this;
  self._validateCallback(onComplete, true);
 ...
 */
FireTwit.prototype.follow = function(user, onComplete) {
  var self = this;
 ...
 */
FireTwit.prototype.post = function(content, onComplete) {
  var self = this;
 ...
 *                                        suggested user.
 */
FireTwit.prototype.getSuggestedUsers = function(onSuggestedUser) {
  var self = this;
 ...
 */
FireTwit.prototype.setProfileField = function(field, value) {
  var peopleRef = this._firebase.child("people").child(this._uid);
 ...
 * spark (see FireTwit.post), which will appear in real-time on the current
 * user's feed!
 *
 ...
 */
FireTwit.prototype.onNewSpark = function(totalCount, onComplete, onOverflow) {
 ...
 */
FireTwit.prototype.onNewSparkFor = function(id, count, onComplete, onOverflow) {
 ...
 *                                   latest set.
 */
FireTwit.prototype.onLatestSpark = function(count, onComplete, onOverflow) {
  this._validateCallback(onComplete, true);
  this._validateCallback(onOverflow, true);
 ...
 * reuse the FireTwit object after calling this and registering new handlers.
 */
FireTwit.prototype.unload = function() {
